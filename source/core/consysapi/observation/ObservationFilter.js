...
class ObservationFilter extends ConnectedSystemsApiFilter {
     ...
     * @param {string[]} [properties.dataStream=undefined] - Comma separated list of data stream local IDs or URIs to get observations for
     * @param {string[]} [properties.system=undefined] - Comma separated list of systems local IDs or URIs to get observations for
     * @param {string[]} [properties.observedProperty=undefined] - Comma separated list of observed property local IDs or URIs to get observations for
